  ...
  async requestPermission() {
    ...
    try {
      ...
      if (permission === "granted") {
        ...
        alert(
          "Вы запретили уведомления. Измените настройки браузера, чтобы включить их.",
        );
        return false;
      }
      return false;
...
/**
 * Получение CSRF-токена из <meta name="csrf-token"> (рендерится в base.html)
 * с fallback на куки lootlink_csrftoken / csrftoken.
 */
function getCsrfToken() {
  ...
  const cookieName = "lootlink_csrftoken";
