...
from . import moderation_views, views, views_faq, views_notifications
...
urlpatterns = [
    ...
    path(
        ...
        views_notifications.notification_settings,
        name="notification_settings",
    ),
    path(
        "notifications/push/subscribe/", views_notifications.subscribe_push, name="subscribe_push"
    ),
    ...
    path(
        "moderation/report/<int:report_id>/process/",
        moderation_views.process_report,
        name="process_report",
    ),
