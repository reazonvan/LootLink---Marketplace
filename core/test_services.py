...
class TestNotificationService:
    ...
    def test_notify_new_message(
        self, seller, buyer, active_listing, conversation_factory, message_factory
    ):
    ...
    def test_format_email_body(self, verified_user):
        ...
        body = NotificationService._format_email_body(
            user=verified_user, message="Test message", link="/test/"
        )
    ...
    def test_format_email_body_escapes_html(self, verified_user):
        ...
        body = NotificationService._format_email_body(
            user=verified_user, message='<script>alert("XSS")</script>', link=""
        )
