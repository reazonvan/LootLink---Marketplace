...
class TestNotificationModel:
    ...
    def test_notification_str(self, verified_user):
        ...
        notification = Notification.objects.create(
            user=verified_user, notification_type="system", title="Test", message="Message"
        )
    ...
    def test_notification_ordering(self, verified_user):
        ...
        notif1 = Notification.objects.create(
            user=verified_user, notification_type="system", title="Old", message="Old"
        )

        notif2 = Notification.objects.create(
            user=verified_user, notification_type="system", title="New", message="New"
        )
