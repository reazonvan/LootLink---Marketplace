...
def admin_dashboard(request):
    ...
    recent_reviews = Review.objects.select_related("reviewer", "reviewed_user").order_by(
        "-created_at"
    )[:5]
