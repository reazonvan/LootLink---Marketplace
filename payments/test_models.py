...
from .models import Wallet, Escrow, Transaction, PromoCode, Withdrawal
...
class WalletTestMixin:
    ...
    def create_user(self, username='testuser', balance=Decimal('1000.00')):
        ...
        wallet, _ = Wallet.objects.get_or_create(user=user, defaults={'balance': balance, 'frozen_balance': 0})
    ...
    def create_listing(self, seller, price=Decimal('500.00')):
        ...
        return Listing.objects.create(
            seller=seller, game=game, title='Test Listing',
            description='Test description', price=price, status='active',
        )
