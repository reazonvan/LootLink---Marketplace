...
urlpatterns = [
    ...
    path(
        "dispute/<int:dispute_id>/message/",
        views_disputes.add_dispute_message,
        name="dispute_add_message",
    ),
    path(
        "dispute/<int:dispute_id>/moderate/",
        views_disputes.moderate_dispute,
        name="dispute_moderate",
    ),
    # Webhooks
