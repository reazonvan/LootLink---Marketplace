    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_id",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="ID платежа в системе"
                    ),
                ),
                (
                    "payment_data",
                    models.JSONField(blank=True, default=dict, verbose_name="Данные платежа"),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "discount_type",
                    models.CharField(
                        choices=[("fixed", "Фиксированная сумма"), ("percent", "Процент")],
                        default="percent",
                        max_length=20,
                ...
                (
                    "uses_count",
                    models.PositiveIntegerField(default=0, verbose_name="Использовано раз"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "admin_comment",
                    models.TextField(blank=True, verbose_name="Комментарий администратора"),
                ),
                (
                    "created_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="Дата создания"),
                ...
                (
                    "processed_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="Дата обработки"),
                ),
                (
                    "user",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "release_deadline",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Дедлайн освобождения"
                    ),
                ),
                (
                    "created_at",
                ...
                (
                    "funded_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Дата заморозки средств"
                    ),
                ),
                (
                    "released_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Дата освобождения средств"
                    ),
                ),
                (
                    "buyer",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "-created_at"], name="payments_tr_user_id_a4b8d9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["status", "-created_at"], name="payments_tr_status_c8e9f1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
