    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["category", "is_active"], name="category_filter_cat_active_idx"
                    ),
                    models.Index(
                        fields=["category", "order"], name="category_filter_cat_order_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "value_text",
                    models.CharField(blank=True, max_length=200, verbose_name="Текстовое значение"),
                ),
                (
                    "value_int",
                    models.IntegerField(blank=True, null=True, verbose_name="Числовое значение"),
                ),
                (
                    "value_bool",
                    models.BooleanField(blank=True, null=True, verbose_name="Булевое значение"),
                ),
                (
                    "category_filter",
                    models.ForeignKey(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["category_filter", "value_text"], name="filter_value_text_idx"
                    ),
                    models.Index(
                        fields=["category_filter", "value_int"], name="filter_value_int_idx"
                    ),
                ],
            },
        ),
