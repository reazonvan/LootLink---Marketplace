...
from . import search_views, views, views_history, views_trading

app_name = "listings"

urlpatterns = [
    path("", views.landing_page, name="home"),
    path("catalog/", views.games_catalog, name="catalog"),  # Каталог игр
    ...
    path(
        "game/<slug:game_slug>/category/<slug:category_slug>/",
        views.category_listings,
        name="category_listings",
    ),  # Новый URL для категорий
    # Жалобы
    ...
    path(
        "listing/<int:listing_id>/make-offer/",
        views_trading.make_price_offer,
        name="make_price_offer",
    ),
    path(
        "listing/<int:listing_id>/reserve/", views_trading.reserve_listing, name="reserve_listing"
    ),
    path(
        "listing/<int:listing_id>/price-history/",
        views_trading.listing_price_history,
    ...
    path(
        ...
        views_trading.cancel_reservation,
    ...
    path(
        "api/games/<slug:game_slug>/categories/",
        views.game_categories_api,
