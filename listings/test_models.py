...
class TestGameModel:
    ...
    def test_game_creation(self):
        """Создание игры."""
        game = Game.objects.create(name="Test Game", description="Test Description")
    ...
    def test_cannot_delete_with_sold_listings_due_to_protect(self, game, seller, listing_factory):
        """P0-21: PROTECT FK не позволяет удалить игру даже с проданными.

        История продаж должна сохраняться навсегда (5 лет по 402-ФЗ РФ).
        Раньше Game.delete разрешал удаление при отсутствии active —
        теперь sold/cancelled тоже блокируют через PROTECT FK.
        """
...
class TestListingModel:
    ...
    def test_price_validation(self, seller, game):
        ...
        listing = Listing(
            seller=seller, game=game, title="Test", description="Test", price=Decimal("-10.00")
        )
...
class TestFavoriteModel:
    ...
    def test_favorite_creation(self, verified_user, active_listing):
        """Создание избранного."""
        favorite = Favorite.objects.create(user=verified_user, listing=active_listing)
...
class TestImageValidation:
    ...
    def test_image_size_validation(self):
        ...
        large_file = SimpleUploadedFile("large.jpg", img_io.getvalue(), content_type="image/jpeg")
    ...
    def test_image_type_validation_valid(self):
        ...
        valid_file = SimpleUploadedFile("valid.jpg", img_io.getvalue(), content_type="image/jpeg")
    ...
    def test_image_type_validation_corrupted(self):
        ...
        corrupted_file = SimpleUploadedFile(
            "corrupted.jpg", b"This is not an image", content_type="image/jpeg"
        )
