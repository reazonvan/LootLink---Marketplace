...
class CategoryFilterAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ("Основная информация", {"fields": ["category", "name", "field_name", "filter_type"]}),
        ("Настройки", {"fields": ["order", "is_required", "is_active"]}),
    ]
...
class FilterOptionAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            ...
            .select_related("filter", "filter__category", "filter__category__game")
        )
    ...
    def get_queryset(self, request):
        return (
            ...
            .select_related(
                "listing",
                "category_filter",
                "category_filter__category",
                "category_filter__category__game",
            )
