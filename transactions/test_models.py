...
class TestPurchaseRequestModel:
    ...
    def test_purchase_request_creation(self, active_listing, buyer, seller):
        ...
        purchase = PurchaseRequest.objects.create(
            listing=active_listing, buyer=buyer, seller=seller, message="I want to buy this"
        )
    ...
    def test_accept_method(self, active_listing, buyer, purchase_request_factory):
        """Метод accept(): требует funded wallet покупателя для эскроу."""
        from decimal import Decimal
...
class TestReviewModel:
    ...
    def test_review_unique_per_purchase_and_reviewer(
        self, active_listing, buyer, seller, purchase_request_factory
    ):
    ...
    def test_review_updates_user_rating(
        self, active_listing, buyer, seller, purchase_request_factory
    ):
